...
function crearProducto() {
  axios.post('http://localhost:3002/productos', {
    nombre: nombre.value,
    precio: precio.value,
    estado: estado.value,
...
<template>
    <div class="bg-gray-/ flex items-center justify-center pt-5 pb-5">
      <div class="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
        ...
        <h2 class="text-2xl font-semibold text-center mb-4">Crear un produto nuevo</h2>
        
        <form @submit.prevent="crearProducto" class="bt-10 bottom-5">
         ...
         <div class="mb-4">
          ...
          <br>
          <br>
          <button type="button" class="w-full bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"><RouterLink to="/products" >Cancelar</RouterLink></button>
